...
class POPNButton extends ButtonControlButton {
  POPNButton(ValueListenable listenable, String name) : super(listenable, name);
  ...
  Widget buildContent(BuildContext context) {
    return Container(
      ...
      shape: () {
        ...
        if (viewNo == 0) return BoxShape.circle;
        return BoxShape.rectangle;
      }(),
      color: () {
        if (button.name.endsWith("1") || (button.name.endsWith("9"))) {
          return button.isDown() ? Color(0xFF501010) : Color(0xFFE0E0E0);
        }
        if (button.name.endsWith("2") || (button.name.endsWith("8"))) {
          return button.isDown() ? Color(0xFF501010) : Color(0xFFF0F050);
        }
        if (button.name.endsWith("3") || (button.name.endsWith("7"))) {
          return button.isDown() ? Color(0xFF501010) : Color(0xFF50B050);
        }
        if (button.name.endsWith("4") || (button.name.endsWith("6"))) {
          return button.isDown() ? Color(0xFF501010) : Color(0xFF5050E0);
        }
        return button.isDown() ? Color(0xFF501010) : Color(0xFFD05050);
      }(),
    ));
  }
}
