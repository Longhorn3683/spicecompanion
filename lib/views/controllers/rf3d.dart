...
class RF3DButton extends ButtonControlButton {
  RF3DButton(ValueListenable listenable, String name) : super(listenable, name);
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Container(
          ...
          child: Icon(() {
            if (button.name.endsWith("View")) return Icons.refresh;
            if (button.name.endsWith("2D/3D")) return Icons.search;
            if (button.name.endsWith("Accelerate")) return Icons.arrow_upward;
            if (button.name.endsWith("Brake")) return Icons.arrow_downward;
