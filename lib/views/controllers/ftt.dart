...
class FTTButton extends ButtonControlButton {
  FTTButton(ValueListenable listenable, String name) : super(listenable, name);
...
class FTTButtonState extends ButtonControlButtonState {
  ...
  Widget buildContent(BuildContext context) {
    return Container(
      ...
      color: () {
        if (button.name.endsWith("1") || (button.name.endsWith("2"))) {
          return button.isDown() ? Color(0xFF501010) : Color(0xFFB0F0FF);
        }
        if (button.name.endsWith("3") || (button.name.endsWith("4"))) {
          return button.isDown() ? Color(0xFF501010) : Color(0xFFF050C0);
        }
